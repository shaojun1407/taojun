...
public class Test {
	...
	private void findPerson() {
		...
		List<Person> persons = (List<Person>) session
				.createQuery("select new Person(p.personId,p.personName) from Person as p").getResultList();
	...
	private void findEmployee() {
		...
		List<Employee> employees = (List<Employee>) session
				.createQuery("select new Employee(e.personId,e.personName,e.job) from Employee as e").getResultList();
	...
	private void findCustomer() {
		...
		List<Customer> customers = (List<Customer>) session
				.createQuery("select new Customer(c.personId,c.personName,c.comment) from Customer as c")
				.getResultList();
